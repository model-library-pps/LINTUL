...
from lintul_3.soil_water_dynamics import SoilWaterDynamics
from lintul_3.soil_nitrogen_dynamics import SoilNitrogenDynamics
...
class Lintul_3_original_SoilWrapper(BaseSoilWrapper):
